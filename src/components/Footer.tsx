...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-black pt-2 pb-6">
      <div className="container mx-auto px-4 sm:px-16 flex flex-col items-center">
        {/* Logo */}
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-center text-gray-600 dark:text-gray-400">
            © 2025 Atelier de l&apos;Endurance. Tous droits réservés. Réalisé
            par{" "}
            <Link
